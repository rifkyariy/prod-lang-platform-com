    ...
    <div v-else class="flex flex-col h-screen">
      ...
      <div class="flex-grow px-6 py-10 sm:px-10 lg:px-20 pt-24">
        ...
        <ol class="list-decimal list-inside text-lg space-y-6">
          <b style="font-size: 32px;">Cara memilih kategori tertentu</b>
          ...
          <li>
            Pada menu awal klik tombol <span class="font-bold">"Let's Start Translation"</span>.
            <!-- Image under step 2 -->
          ...
          <li>
            Pada menu pemilihan translation terdapat filter disebelah kiri.
            <!-- Image under step 2 -->
            <div class="mt-4 flex justify-center">
              <img src="@/assets/images/filter.png" alt="Sign In Image" class="rounded-lg shadow-lg" style="width: 750px; height: auto;">
            </div>
          </li>
          <li>
            Pilih translator yang sesuai pada menu filter.
            <!-- Image under step 3 -->
            <!-- <div class="mt-4 flex justify-center">
