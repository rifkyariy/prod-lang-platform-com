    ...
    <div v-else class="flex flex-col h-screen">
      ...
      <div class="flex-grow px-6 py-10 sm:px-10 lg:px-20 pt-24">
        ...
        <ol class="list-decimal list-inside text-lg space-y-4">
          <b style="font-size: 32px;">Cara bergabung sebagai fasilitator</b>
          ...
          <li>
            Klik tombol <span class="font-bold">"Sign in as Facillitator"</span> yang berada di pojok kanan atas.
            <!-- Image under step 2 -->
          ...
          <li>
            Setelah selesai membuat email dan password kembali ke menu awal klik pada profile di kanan atas dan pilih pada menu profile.
            <!-- Image under step 4 -->
            <div class="mt-4 flex justify-center">
              <img src="@/assets/images/profile.png" alt="Email and Password Image" class="rounded-lg shadow-lg" style="width: 750px; height: auto;">
            </div>
          </li>
          <li>
            Lengkapi informasi data pribadi.
            <!-- Image under step 4 -->
            <div class="mt-4 flex justify-center">
              <img src="@/assets/images/personal.png" alt="Email and Password Image" class="rounded-lg shadow-lg" style="width: 750px; height: auto;">
            </div>
          </li>
          <li>
            Setelah itu muncul tampilan penjelasan seperti ini.
            <!-- Image under step 4 -->
            <div class="mt-4 flex justify-center">
              <img src="@/assets/images/view.png" alt="Email and Password Image" class="rounded-lg shadow-lg" style="width: 750px; height: auto;">
            </div>
          </li>
          <li>
            Setelah itu kembali lagi ke halaman menu awal dan verifikasi sekali lagi pada menu profile di kanan atas.
            <!-- Image under step 4 -->
            <div class="mt-4 flex justify-center">
              <img src="@/assets/images/cek.png" alt="Email and Password Image" class="rounded-lg shadow-lg" style="width: 750px; height: auto;">
            </div>
          </li>
        </ol>
